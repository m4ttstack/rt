...
describe('covers', () => {
  ...
  it('treats sub-day drift within the same calendar day as covered', () => {
    ...
    const inner: TimeWindow = {
      start: '2026-01-16T21:45:09.963Z',
      end: '2026-07-15T00:00:00.000Z',
      key: '90d',
    };
    const outer: TimeWindow = {
      start: '2026-01-16T21:45:09.969Z',
      end: '2026-07-15T00:00:00.100Z',
      key: 'base180',
    };
