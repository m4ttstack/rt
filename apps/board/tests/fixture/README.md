...
by the repo root's `scripts/repo-purity.sh`, and the 20 PNGs in
...
| !1235 | the own MR: approved, the Slack `eyes` reaction and posted logo, five resolved threads, a peer (`pat`) reviewing                                                                                                      |
| !1273 | the all-clear row: approved, Slack `white_check_mark` posted, nothing else                                                                                                                                            |
...
wrong-section banner and chip render.
