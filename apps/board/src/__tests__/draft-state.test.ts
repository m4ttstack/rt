...
describe('draft state', () => {
  test('write, read, and group held drafts by MR', () => {
    const d = dir();
    writeDraft(draftFilePath('https://x/mr/1', 'inherited-note', d), {
      mrUrl: 'https://x/mr/1',
      iid: 1,
      kind: 'inherited-note',
    ...
    writeDraft(draftFilePath('https://x/mr/1', 'rebase-note', d), {
      mrUrl: 'https://x/mr/1',
      iid: 1,
      kind: 'rebase-note',
      body: 'needs rebase',
    ...
    writeDraft(draftFilePath('https://x/mr/2', 'inherited-note', d), {
      mrUrl: 'https://x/mr/2',
      iid: 2,
      kind: 'inherited-note',
      body: 'x',
  ...
  test('prune drops drafts whose MR left the board; attach decorates rows', () => {
    const d = dir();
    writeDraft(draftFilePath('https://x/mr/1', 'k', d), {
      mrUrl: 'https://x/mr/1',
      iid: 1,
      kind: 'k',
      body: 'b',
    ...
    writeDraft(draftFilePath('https://x/mr/9', 'k', d), {
      mrUrl: 'https://x/mr/9',
      iid: 9,
      kind: 'k',
      body: 'b',
