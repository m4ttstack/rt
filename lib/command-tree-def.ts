    ...
    subcommands: {
      ...
      app: {
        ...
        args: [
          ...
          { name: "Yes notes", flag: "--yes-notes", type: "text", placeholder: "3f9c2a7b1e04", hint: "Approve the notes a stopped run showed, by their hash (or the tag they were shown for); refused if the notes changed since" },
