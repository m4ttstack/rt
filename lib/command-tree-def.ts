...
export const TREE: Record<string, CommandNode> = {
  ...
  agent: {
    ...
    args: [
      ...
      { name: "Provider", flag: "--provider", type: "text", placeholder: "claude | codex", hint: "Which CLI to launch (override agent.provider, default claude)" },
      { name: "Model", flag: "--model", type: "text", placeholder: "sonnet", hint: "Override agent.<provider>.model" },
      { name: "Effort", flag: "--effort", type: "text", placeholder: "high", hint: "Override agent.<provider>.effort" },
      { name: "Yolo", flag: "--yolo", type: "boolean", default: false, hint: "Bypass permission prompts for this launch (override agent.<provider>.yolo)" },
      { name: "No yolo", flag: "--no-yolo", type: "boolean", default: false, hint: "Keep permission prompts for this launch even when agent.<provider>.yolo is true" },
      ...
      { name: "Extra args", flag: "--extra-args", type: "text", placeholder: "\"--foo bar\"", hint: "Opaque extra provider arguments appended to the launch (override agent.<provider>.extraArgs)" },
