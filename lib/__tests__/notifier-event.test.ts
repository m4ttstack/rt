...
test("notifyEvent queues an event that keeps its team and handle for the tray's click routing, and reports the queue write", () => {
  const queuedOk = notifyEvent({ title: "ed replied to your acme invite", message: "Add ed to acme?", category: "member_joined", team: "acme", handle: "ed" });
