...
const REGISTRY: SettingDef[] = [
  ...
  },
  {
    ...
    merge: "deep",
    migrated: false,
    legacyFile: "workspace-sync.json",
  ...
  },
  {
    ...
    merge: "deep",
    migrated: false,
    legacyFile: "doppler-template.yaml",
