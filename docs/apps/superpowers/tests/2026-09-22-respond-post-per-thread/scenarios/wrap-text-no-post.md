...
You built Gate 2 yourself (thread-1, queue/enqueue.ts:88, options post:T1 and resolve:T1; thread-2, queue/README.md:12, options post:T2 and resolve:T2), opened it with --kind respond-post (presentation "wait"), and the background wait has now returned:
{"answers": {"thread-1": {"value": ["resolve:T1"], "text": "Fixed in ab12cd3, with a test for the empty queue."}, "thread-2": ["post:T2"]}, "by": "board-ui", "answeredAt": 1790000000000}
