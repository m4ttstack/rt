...
What the forge shows when you read !87's discussions: T1 carries renee's note and then a note by the account this pane posts as, dated 1790000160000, whose text is the report's T1 reply; T1 is unresolved. T2 and T3 carry renee's note only.
