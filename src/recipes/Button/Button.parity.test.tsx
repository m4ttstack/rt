...
> = {
  ...
  "ghost|muted|dark": { restBg: "rgba(0, 0, 0, 0)", restColor: "color(srgb 0.652549 0.677647 0.792941)", restBorder: "rgba(0, 0, 0, 0)", hoverBg: "color(srgb 0.135216 0.13898 0.184941)", hoverColor: "color(srgb 0.652549 0.677647 0.792941)", hoverBorder: "rgba(0, 0, 0, 0)" },
  "ghost|muted|light": { restBg: "rgba(0, 0, 0, 0)", restColor: "color(srgb 0.34902 0.36549 0.447843)", restBorder: "rgba(0, 0, 0, 0)", hoverBg: "color(srgb 0.840941 0.847686 0.881412)", hoverColor: "color(srgb 0.34902 0.36549 0.447843)", hoverBorder: "rgba(0, 0, 0, 0)" },
  ...
  "subtle|accent|dark": { restBg: "rgb(44, 51, 82)", restColor: "color(srgb 0.560784 0.689412 0.967843)", restBorder: "rgba(0, 0, 0, 0)", hoverBg: "color(srgb 0.209255 0.252235 0.399216)", hoverColor: "color(srgb 0.560784 0.689412 0.967843)", hoverBorder: "rgba(0, 0, 0, 0)" },
  "subtle|accent|light": { restBg: "rgb(246, 246, 250)", restColor: "color(srgb 0.157647 0.40549 0.744314)", restBorder: "rgba(0, 0, 0, 0)", hoverBg: "color(srgb 0.870588 0.907765 0.972392)", hoverColor: "color(srgb 0.157647 0.40549 0.744314)", hoverBorder: "rgba(0, 0, 0, 0)" },
  ...
  "subtle|muted|dark": { restBg: "rgb(44, 51, 82)", restColor: "color(srgb 0.612941 0.639608 0.764314)", restBorder: "rgba(0, 0, 0, 0)", hoverBg: "color(srgb 0.211137 0.239059 0.364392)", hoverColor: "color(srgb 0.612941 0.639608 0.764314)", hoverBorder: "rgba(0, 0, 0, 0)" },
  "subtle|muted|light": { restBg: "rgb(246, 246, 250)", restColor: "color(srgb 0.396078 0.415294 0.511373)", restBorder: "rgba(0, 0, 0, 0)", hoverBg: "color(srgb 0.913412 0.916706 0.94698)", hoverColor: "color(srgb 0.396078 0.415294 0.511373)", hoverBorder: "rgba(0, 0, 0, 0)" },
