    ...
    <Stack gap="lg" px="xl" py="xl" style={{ maxWidth: "96rem", margin: "0 auto" }}>
      ...
      {data && (
        <>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "16rem minmax(0, 1fr)", gap: 24, alignItems: "start" }}>
  ...
  return (
    <Stack gap="md" style={{ position: "sticky", top: 24, alignSelf: "start" }}>
      {GROUPS.map((g) => {
        ...
        return (
          <div key={g.key}>
            <Text size="10px" tt="uppercase" c={g.color} mb={4} style={{ letterSpacing: "0.06em" }}>
              {g.label}
            </Text>
                ...
                return (
                  <button
                    ...
                    style={{
                      ...
                      cursor: "pointer",
                      font: "inherit",
                      backgroundColor: active ? bg.color("accent") : "transparent",
                    }}
                  >
                    <Text component="span" size="sm" c={active ? "accent" : undefined} truncate>
                      {c.label}
                    </Text>
                    <span
                      style={{
  ...
  return (
    <Stack gap="sm" style={{ minWidth: 0 }}>
      <Group justify="space-between" align="flex-end" wrap="wrap" gap="sm">
        ...
        <Group gap="sm" align="baseline" style={{ fontFamily: "var(--mantine-font-family-monospace)" }}>
          <Text size="xl" fw={700}>
          ...
          {delta !== null && delta !== 0 && <DeltaBadge delta={delta} col={col} />}
        </Group>
      </Group>
