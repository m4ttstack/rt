...
// eslint-disable-next-line no-restricted-imports -- shadow definition site: this IS the `@ui/core` Table the eslint wall (eslint.config.js) points everything else at.
