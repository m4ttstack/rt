...
if (changed) writeFileSync("probe/package.json", JSON.stringify(pkg, null, 2) + "\n");
console.log(changed ? "probe deps repointed at freshly packed tarballs" : "probe deps already current");
