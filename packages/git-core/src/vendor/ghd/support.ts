...
// Source: app/src/ui/diff/text-diff-expansion.ts (lines 88-118)
...
// Source: app/src/ui/diff/diff-helpers.tsx (lines 378-400)
/** Utility function for getting the digit count of the largest line number in an array of diff hunks */
export function getLargestLineNumber(hunks: ReadonlyArray<DiffHunk>): number {
  if (hunks.length === 0) {
    return 0
  }
