...
// Anchored on this file's own directory, not process.cwd(): a workspace
// project run and a direct package run leave the process cwd at different
// depths, but scheme-vars.css is always this file's sibling.
const CSS_PATH = path.resolve(import.meta.dirname, 'scheme-vars.css');
