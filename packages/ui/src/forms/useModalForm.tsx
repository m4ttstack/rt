...
import type { OpenModalOptions } from '@mattstack/app-kit/modals';
...
// gets mounted where `@mattstack/app-kit/modals` renders it -- that's what makes typing
...
/**
 * Opens a modal (via `@mattstack/app-kit/modals`) hosting a zod-validated form.
 *
 ...
 *
 * This kit's version owns the modal itself (via `@mattstack/app-kit/modals`, matching the
