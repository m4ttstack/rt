/* eslint-disable no-restricted-imports -- deliberately importing the real mantine originals to prove @mattstack/app-kit/core's shadows are NOT the same reference. */
import {
...
import { CopyButton, Table, TextInput } from '@mattstack/app-kit/core';
import {
  FormContainer,
  identifierRegex,
  useModalForm,
  zodResolver,
} from '@mattstack/app-kit/forms';
...
// --- @mattstack/app-kit/core shadows --------------------------------------------------

test('@mattstack/app-kit/core TextInput is a shadow, not a re-export of @mantine/core TextInput', () => {
  expect(TextInput).not.toBe(MantineTextInput);
});

test('@mattstack/app-kit/core Table is a shadow, not a re-export of @mantine/core Table', () => {
  expect(Table).not.toBe(MantineTable);
});

test('@mattstack/app-kit/core CopyButton is a shadow, not a re-export of @mantine/core CopyButton', () => {
