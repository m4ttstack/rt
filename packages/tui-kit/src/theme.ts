 ...
 * minus `transparent`/`link`, plus `filled` (restored: the gate surfaces ship
 * a solid tier): nothing in the TUI look paints `transparent`/`link`, and a
...
export const tuiVocabulary = {
  ...
  variant: defineVocabulary(["default", "filled", "light", "outline", "subtle"] as const),
};

/**
 * The Tokyo Day / Tokyo Night theme.
 *
 * Colours and fonts come from src/generated/tokens.ts (generated by
 * packages/tokens; see that file's header). Every other scale below is
 * mr-board's exact string, cross-checked against docs/token-census.md --
 * nothing here may be rounded, re-derived, or "cleaned up".
 *
...
export const TUI_DARK_COLORS = GENERATED_DARK_COLORS;
...
export const tuiTheme = createTheme({
  ...
  semanticTokens: {
    ...
    border: {
      ...
      "soft-on-card": "colors.line.softOnCard",
    },
  },
});
