...
`rt team create` never pushes. Setup's Install step pushes the zone, or you can push it yourself:
...
`rt skills sync` is a different tool, for a pack's author: it pulls the pack and engine checkouts, recompiles and pushes a new version when the compiled skills have drifted, and updates the installed plugins.
