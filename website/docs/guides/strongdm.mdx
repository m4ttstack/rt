...
A resource missing from the file just shows its raw name and connects with Postgres defaults. Keep the file in your own repo and copy or symlink it to `~/.mattstack/rt/sdm/enrichment.jsonc` to share it with your team.
