...
The daemon does not manage or supervise other processes, run scripts, or provide tunnels. It only does the caching, scanning, and hook-guarding described above.
